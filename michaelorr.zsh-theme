...
PROMPT='%{$fg[red]%}➜ %{$fg[white]%}$(virtualenv_prompt_info)%{$fg[cyan]%}$USER%{$fg[blue]%}@%{$fg[white]%}$HOSTNAME_ALIAS%{$fg[blue]%}❯%{$fg[cyan]%}%1/%{$fg[blue]%}$(git_prompt_info)%{$fg[blue]%}❯%{$reset_color%} '
